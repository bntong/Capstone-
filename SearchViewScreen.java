 ...
 */
public class SearchViewScreen extends JFrame
{
    ...
    private ArrayList<MusicSheet> musicList;
    
    private MainScreen mainScreen;
    /**
     * Default constructor for objects of class View
     */
    public SearchViewScreen(ArrayList<MusicSheet> list)
    {
...
//         this.add(this.question , BorderLayout.NORTH);
        ...
        Object[][] data = new Object[this.musicList.size()][5];
